...
public class MChartStartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mchart_activity_start);
    ...
    public void getIntro() {
        try {
            ...
            InputStream inputStream = getAssets().open("M-chartINTRO.json");
