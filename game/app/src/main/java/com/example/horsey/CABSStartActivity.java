...
public class CABSStartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cabs_activity_start);
    ...
    public void loadTransactions() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(CABSStartActivity.this,CABSMainActivity2.class);
    ...
    public void getIntro() {
        try {
            ...
            InputStream inputStream = getAssets().open("CABSINTRO.json");
