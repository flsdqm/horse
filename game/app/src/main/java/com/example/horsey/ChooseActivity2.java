...
public class ChooseActivity2 extends AppCompatActivity {
    ...
    private int count=1;
    private String s="choose_pingpong";
    private String needToChoose="clock";
                    ...
                    public void onClick(View view) {
                        ...
                        if(option==""){
                            ...
                            if (s.equals(json)){
                                ...
                                toast.show();
                                Intent intent=new Intent(ChooseActivity2.this,MainActivity.class);
                                Bundle bundle=new Bundle();
                                GameType gameType=new GameType("语义游戏",option,json,s,needToChoose);
    ...
    private void getOptions() {
        try {
            ...
            InputStream inputStream = getAssets().open("yuyi.json");
