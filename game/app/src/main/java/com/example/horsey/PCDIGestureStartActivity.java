...
public class PCDIGestureStartActivity extends AppCompatActivity {
...
//        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
    ...
    public void loadTransactions() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(PCDIGestureStartActivity.this,PCDIGestureMainActivity2.class);
    ...
    public void getIntro() {
        try {
            ...
            InputStream inputStream = getAssets().open("PCDIGestureINTRO.json");
